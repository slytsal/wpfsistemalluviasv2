...
namespace Protell.DAL.Repository
{
    public class EstPuntoMedRepository : IEstPuntoMed
    {
        ...
        // Read ID varios.
        public IEnumerable<Model.EstPuntoMedModel> GetEstPuntoMedID(Model.PuntoMedicionModel puntoMedicionModel)
        {
            ObservableCollection<Model.EstPuntoMedModel> PuntoMedicionEstructura = new ObservableCollection<Model.EstPuntoMedModel>();
            using (var entity = new db_SeguimientoProtocolo_r2Entities())
            {
                try
                {
                    ...
                    (from o in entity.REL_EST_PUNTOMED
                     where o.IdPuntoMedicion == puntoMedicionModel.IdPuntoMedicion && o.IsActive == true
                     select o).ToList().ForEach(p =>
                     {
                         PuntoMedicionEstructura.Add(new Model.EstPuntoMedModel()
                         {
            ...
            return PuntoMedicionEstructura;
        }
