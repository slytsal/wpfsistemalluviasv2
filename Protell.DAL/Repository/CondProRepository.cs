                ...
                using (var entity = new db_SeguimientoProtocolo_r2Entities())
                {
                    foreach (Model.CondProModel item in condpro)
                    {
                        ...
                        if (query.Count > 0)
                        {
                            ...
                            if (local.LastModifiedDate < item.LastModifiedDate|| local.ServerLastModifiedDate<item.ServerLastModifiedDate )
            ...
            if (condpro != null && context != null)
            {
                ...
                if (entity != null)
                {
                    ...
                    if (result != null)
                    {
                        ...
                        result.ServerLastModifiedDate = condpro.ServerLastModifiedDate;
                        entity.SaveChanges();
                    }
                }
            }
