...
{
    public class TipoPuntoMedicionAddViewModel : ViewModelBase
    {        
        // ***************************** ***************************** *****************************
        // Repository.
        ...
        public void AttemptSave()
        {
            ...
            this._TipoPuntoMedicionRepository.InsertTipoPuntoMedicion(this._TipoPuntoMedicion);
        }


        // ***************************** ***************************** *****************************
        // constructor
        public TipoPuntoMedicionAddViewModel()
        {
            ...
            {
                IdTipoPuntoMedicion = new UNID().getNewUNID(),
                IsActive = true
            };
        }
    }
