...
{
    public class DependenciaModViewModel : ViewModelBase
    {        
        // ***************************** ***************************** *****************************
        // Repository.
        ...
        public bool CanSave()
        {
            ...
            {
                _CanSave = true;
                this._CheckSave = this._DependenciaRepository.GetDependenciaMOD(this._Dependencia);
        ...
        public void AttemptSave()
        {
            ...
            this._DependenciaRepository.UpdateDependencia(this._Dependencia);
        }
