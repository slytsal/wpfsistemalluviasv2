...
{
    public class SistemaModViewModel : ViewModelBase
    {        
        // ***************************** ***************************** *****************************
        // Repository.
        ...
        public bool CanSave()
        {
            ...
            {
                _CanSave = true;
                this._CheckSave = this._SistemaRepository.GetSistemaMOD(this._Sistema);
        ...
        public void AttemptSave()
        {
            ...
            this._SistemaRepository.UpdateSistema(this._Sistema);
        }
