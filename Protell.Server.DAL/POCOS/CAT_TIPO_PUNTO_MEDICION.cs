...
{
    public partial class CAT_TIPO_PUNTO_MEDICION
    {
        ...
        private void FixupCAT_PUNTO_MEDICION(object sender, NotifyCollectionChangedEventArgs e)
        {
            if (e.NewItems != null)
            {
                ...
                {
                    item.CAT_TIPO_PUNTO_MEDICION = this;
                }
            }
            ...
            if (e.OldItems != null)
            {
                ...
                {
                    if (ReferenceEquals(item.CAT_TIPO_PUNTO_MEDICION, this))
                    {
                        item.CAT_TIPO_PUNTO_MEDICION = null;
                    }
                }
            }
        }
